...
LLB_LOG_DIR=$USIV_LOG_ABSDIR

LLB_LOG_LAST=$USIV_LOG_LAST
LLB_LOG_SAME=$LLB_LOG_DIR/same-$LLB_EXE.$USIV_LOG_EXTENSION
LLB_LOG_HIST=$LLB_LOG_DIR/hist-$(date +'%Y%m%d-%H%M%Sp%N')-$LLB_EXE.$USIV_LOG_EXTENSION
